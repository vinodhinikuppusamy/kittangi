...
### Backend (API Server)
The backend uses Express 5 with MongoDB via Mongoose. Zod is used for shared request/response validation, and Orval generates API hooks and Zod schemas from OpenAPI specifications.
